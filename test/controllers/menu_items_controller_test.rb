...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference("MenuItem.count") do
      post menu_items_url, params: { menu_item: { description: @menu_item.description, establishment_id: @menu_item.establishment_id, name: @menu_item.name, photo: @menu_item.photo, price: @menu_item.price } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { description: @menu_item.description, establishment_id: @menu_item.establishment_id, name: @menu_item.name, photo: @menu_item.photo, price: @menu_item.price } }
