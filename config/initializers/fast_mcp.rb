...
FastMcp.mount_in_rails(
  ...
  authenticate: false,       # Uncomment to enable authentication
  ...
  Rails.application.config.after_initialize do
    ...
    server.register_resource(CategoryResource)
    server.register_resource(ReservationResource)
    server.register_resource(MenuItemResource)
    server.register_resource(UserResource)
    server.register_resource(EstablishmentResource)
  end
end
